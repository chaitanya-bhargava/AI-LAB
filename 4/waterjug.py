#Problem - Given a capacity of two jugs j1 and j2, measure given goal (g) amount of water using 8 rules.
...
def apply_rule(ch, x, y):
    ...
    if ch == 4:
      # jug 2 should not be empty and jug 1 + jug 2 should not be more than pr equal to capacity of jug 1 
      if y > 0 and x+y <= j1:
        return x+y,0
      else:
        print("Rule cannot be applied")
